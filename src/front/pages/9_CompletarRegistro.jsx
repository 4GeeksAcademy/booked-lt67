...
const CompletarRegistroLector = () => {
    ...
    // Función unificada para enviar datos (con o sin campos opcionales)
    const sendData = (e) => {
        ...
        const requestOptions = {
            ...
            body: JSON.stringify({
                ...
                "pais_donde_reside": pais || null, // Coincide con el nombre en tu db.Model
        ...
        fetch(`${baseUrl}/api/signup_lector`, requestOptions)
            ...
            .then(data => {
                ...
                dispatch({
                    ...
                    payload: { 
                        auth: true, 
                        id: data.lector_id, 
                        nombre: data.nombre || username // Si no hay nombre, usamos el username
                    }
                });
            ...
            .catch(err => {
                ...
                alert("No se pudo completar el registro. Verifica que el servidor esté activo.");
                setCargando(false);
            });
    }
                        ...
                        >
                            ...
                            <div className="position-relative z-index-1">
                                ...
                                <p className="small opacity-75 mb-4">
                                    Puedes completar tu perfil ahora o entrar directamente y hacerlo después.
                                </p>
                            </div>
                        </div>
                        ...
                        <div className="col-lg-8 bg-white p-4 p-md-5">
                            <div className="mb-4 pb-2 border-bottom d-flex justify-content-between align-items-end flex-wrap gap-2">
                                <div>
                                    ...
                                    <span className="text-info-booked fw-bold small text-uppercase" style={{ letterSpacing: '1px' }}>— Datos Opcionales</span>
                                </div>
                            ...
                            <form onSubmit={sendData}>
                                <div className="row g-3">
                                    ...
                                    <div className="col-md-6 mb-1">
                                        ...
                                        <div className="input-group shadow-sm rounded-pill overflow-hidden">
                                            ...
                                            <input value={nombre} onChange={(e) => setNombre(e.target.value)} type="text" className="form-control bg-light border-0 py-2 ps-2" placeholder="Ej: Juan" />
                                        </div>
                                    </div>
                                    ...
                                    <div className="col-md-6 mb-1">
                                        ...
                                        <div className="input-group shadow-sm rounded-pill overflow-hidden">
                                            <input value={apellido} onChange={(e) => setApellido(e.target.value)} type="text" className="form-control bg-light border-0 py-2 px-4" placeholder="Ej: Pérez" />
                                        </div>
                                    </div>
                                    ...
                                    <div className="col-md-12 mb-1 mt-3">
                                        ...
                                        <div className="input-group shadow-sm rounded-pill overflow-hidden">
                                            ...
                                            <input value={pais} onChange={(e) => setPais(e.target.value)} type="text" className="form-control bg-light border-0 py-2 ps-2" placeholder="Ej. Chile" />
                                        </div>
                                    </div>
                                    ...
                                    <div className="col-12 mt-3 mb-4">
                                        ...
                                        <div className="rounded-4 overflow-hidden border shadow-sm bg-light p-1" style={{ height: "200px" }}>
                                ...
                                <div className="d-grid gap-3 mt-2">
                                    <button 
                                        ...
                                        disabled={cargando}
                                    >
                                        {cargando ? "Procesando..." : "GUARDAR Y FINALIZAR"}
                                    </button>
                                    ...
                                    <button 
                                        type="button" 
                                        onClick={() => sendData()} 
                                        className="btn btn-outline-secondary btn-sm rounded-pill border-0 text-muted"
                                        disabled={cargando}
                                    >
                                        Omitir este paso por ahora <i className="fas fa-chevron-right ms-1"></i>
                                    </button>
                                </div>
                            </form>
                        </div>
