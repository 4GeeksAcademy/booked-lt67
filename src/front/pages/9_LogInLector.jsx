...
const LogInLector = () => {
    ...
    // Redirección si ya está autenticado como lector
    ...
    function sendData(e) {
        ...
        const urlFinal = `${baseUrl}/api/login_lector`;
                    ...
                    <div className="row g-0">
                        ...
                        >
                            ...
                            <div className="position-relative z-index-1">
                                ...
                                <p className="small opacity-75 mb-4">
                                    Vuelve a tus lecturas, descubre nuevas historias y sigue compartiendo tu opinión con el mundo.
                                </p>
                                <hr className="w-25 mx-auto border-white opacity-50 mb-4" />
                                <p className="small mb-0">¿Aún no tienes cuenta?</p>
                                <Link to="/signup_lector" className="btn btn-outline-light rounded-pill px-4 mt-2 fw-bold shadow-sm">
                                    Regístrate aquí
                                </Link>
                            </div>
                        </div>
                        ...
                        <div className="col-lg-7 bg-white p-4 p-md-5 d-flex flex-column justify-content-center">
                            <div className="mb-5 pb-2 border-bottom d-flex justify-content-between align-items-end">
                                <div>
                                    <h2 className="fw-bold text-dark h3 mb-1">Acceso a Lectores</h2>
                            ...
                            <form onSubmit={sendData}>
                                ...
                                <div className="d-grid mt-5">
                                    ...
                                    >
                                        {cargando ? (
                                            <><span className="spinner-border spinner-border-sm me-2" aria-hidden="true"></span> Accediendo...</>
                                        ) : (
                                            <>INGRESAR A MI CUENTA <i className="fas fa-arrow-right ms-2"></i></>
                                        )}
                                    </button>
                                </div>
                            </form>
